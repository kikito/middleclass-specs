...
Get the code from github normally, and then update the submodules (*don't forget this step, otherwise middleclass will not be downloaded and you will not be able to run the specs!*)
...
Open a console and change to the middleclass-specs top-directory:

<pre>
cd middleclass-specs
</pre>

Then execute @lua run.lua@. It should be configured to start the testing automatically.
<pre>
lua run.lua
</pre>
